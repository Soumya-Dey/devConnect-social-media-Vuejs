<template>
  <nav class="navbar bg-dark">
    <h1>
      <router-link to="/" class="nav-h1">
        Dev
        <i class="fas fa-code"></i> Connect
      </router-link>
    </h1>

    <div v-if="!authLoadingStatus">
      <ul v-if="authenticationStatus">
        <li>
          <router-link to="/posts">Posts Feed</router-link>
        </li>
        <li>
